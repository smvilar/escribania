...
<main class="flex flex-col items-center bg-slate-100 min-h-screen">
  ...
  <section id="servicios" class="h-min m-px p-2 sm:px-20 sm:py-16 max-w-screen-lg">
    ...
    <ul class="flex flex-wrap gap-1 sm:gap-8">
      <li class="sm:max-w-[45%] bg-purple-400/20 rounded sm:rounded-lg p-2 sm:p-4">
        <h4>Familiar</h4>
        <small>
      ...
      <li class="sm:max-w-[45%] bg-purple-400/10 rounded sm:rounded-lg p-2 sm:p-4">
        <h4>Bancario</h4>
        <small>
      ...
      <li class="sm:max-w-[45%] bg-purple-400/20 sm:bg-purple-400/10 rounded-lg p-4">
        <h4>CORPORATIVO</h4>
        <small>
      ...
      <li class="sm:max-w-[45%] bg-purple-400/10 sm:bg-purple-400/20 rounded-lg p-4">
        <h4>INMOBILIARIO</h4>
        <small>
      ...
      <li class="sm:max-w-[45%] bg-purple-400/20 sm:bg-purple-400/20 rounded-lg p-4">
        <h4>NOTARIALES</h4>
        <small>
      ...
      <li class="sm:max-w-[45%] bg-purple-400/10 sm:bg-purple-400/10 rounded-lg p-4">
        <h4>AUTOMOTORES</h4>
        <small>
  ...
  <section id="trayectoria" class="h-min m-px p-2 sm:px-20 sm:py-16 max-w-screen-lg">
    ...
    <article class="py-2 text-sailing-blue-dark">
      <img class="self-center" alt="Patricia Lanzón" width="400" height="400" src="/img/carnet.jpg">
      <img class="" alt="Jorge M. Lanzón" width="400" height="400" src="/img/jorge.jpg" />
      <p>Escribano Jorge Mario Lanzón. Fundador.</p>
      <img class="float-left mr-2" alt="Recibida de Abogada" width="400" height="400" src="/img/diploma.jpg" />
      <p class="p-2 sm:text-lg">
        <strong>Patricia Adriana Lanzón</strong> es escribana titular del Registro 570
        de la Ciudad autónoma de Buenos Aires desde 1995, por concurso de oposición
        y antecedentes, con título de Abogada de la Universidad de Buenos Aires.
      </p>
      <img alt="Colegio de Escribanos" width="400" height="400" src="/img/registro.jpg" />
      <p class="clear-left p-2 sm:text-lg">
        Desde 2007 participa de la organización del <strong>registro de actos de
        autoprotección</strong> del Colegio de Escribanos de CABA, y es
        <strong>Presidenta de la Comisión de Derechos Humanos, Personalísimos y de
        autoprotección</strong> de dicha institución desde el año 2017. Activamente
        participa de la docencia sobre este tema, entre otros eventos: en 2013 formó
        parte del <strong>Taller sobre Derecho de autoprotección</strong> organizado
        por el Consejo Federal del Notariado Argentino; en 2018 participó del dictado
        del <strong>Seminario Mario Zinny</strong> sobre
        <strong>Actos de autoprotección</strong> en el Colegio de Escribanos de Salta,
        Argentina.
      </p>
      <div class="float-left mr-2">
        <img class="sm:w-60" alt="Publicación de libro" width="400" height="400" src="/img/libro.jpg" />
        <img class="sm:w-60" alt="En el Senado de la Nación" width="400" height="400" src="/img/senado.jpg" />
      </div>
      <p class="p-2 sm:text-lg">
        Durante el año 2020 forma virtual ha participado de charlas
        virtuales sobre el tema para abogados y escribanos de Córdoba, Argentina
        así como para colegas de su misma Ciudad. Ha publicado diversos artículos y
        en JUNIO de 2017 el libro <strong>Directivas Anticipadas</strong> de Di Lalla Ediciones.
        En 2022 participó, junto con otros colegas de diversas jurisdicciones, de la
        redacción del Proyecto de Ley 669/22 de Ley Nacional de Autoprotección y
        mandato preventivo, en tratamiento en el Senado de la Nación. 
        Se encuentra finalizando la Tesis de la Maestría sobre Derecho de la Vejez
